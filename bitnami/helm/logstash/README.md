...
$ helm install -n elasticsearch logstash  bitnami/logstash -f values-silkrode.yaml
$ helm upgrade -n elasticsearch logstash  bitnami/logstash -f values-silkrode.yaml --dry-run

```

## grafana Logstash metrics

import 2525 grafana dashbroad
