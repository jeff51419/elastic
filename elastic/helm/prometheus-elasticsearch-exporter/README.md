...
#Helm 3 install
$ helm install -n ${NAMESPACE} --values=exporter-values.yaml --dry-run ${RELEASE} prometheus-community/prometheus-elasticsearch-exporter
$ helm install -n ${NAMESPACE} --values=exporter-values.yaml ${RELEASE} prometheus-community/prometheus-elasticsearch-exporter

#Helm 3 uninstall
$ helm uninstall [RELEASE_NAME]

#Helm 3 or 2 upgrade
$ helm upgrade ${RELEASE} --values=exporter-values.yaml prometheus-community/prometheus-elasticsearch-exporter -n ${NAMESPACE} --dry-run
```

login grafana and import 6483 dashboard
https://grafana.com/grafana/dashboards/6483/reviews
